...
- (void)setUI
{
    ...
    switchBgView.backgroundColor = [UIColor grayColor];
    ...
    self.timeBgView.layer.borderColor = [UIColor redColor].CGColor;
    self.timeBgView.backgroundColor = [UIColor grayColor];
    ...
    self.validTimeLabel.textColor = [UIColor whiteColor];
    ...
    self.restTimeLabel.textColor = [UIColor whiteColor];
